...
class sort_lc {
  ...
  /**
    ...
    * Associative arrays must have the call numbers as the key
    *
    * @access public
    * @param array Array of Library of Congress call numbers to sort
    * @return NULL
    *
    */
  ...
  /********************************************************************
  #
  #  Two PHP functions to sort Library of Congress (LC) call numbers
  #  From: https://github.com/kenirwin/Weeding-Helper/blob/master/sortLC.php
  #
  #  Version: 0.1 alpha 
  #
  ...
  ********************************************************************/
  ...
  private static function SortLC ($right, $left) {
    $right = self::NormalizeLC($right);
    $left = self::NormalizeLC($left);
  ...
  private static function NormalizeLC ($lc_call_no_orig) {
    /*
