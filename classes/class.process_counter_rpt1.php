...
class process_counter_rpt1 extends process {
  ...
  public function __construct() {
    ...
    try {
      ...
      $sql      = 'SELECT id AS temp_id, title, publisher, platform, doi, proprietary_identifier, isbn, issn, counter_br1, usage_year, vendor FROM temp_counter_br1 LIMIT ' . config::PROCESS_LIMIT . ' FOR UPDATE';
