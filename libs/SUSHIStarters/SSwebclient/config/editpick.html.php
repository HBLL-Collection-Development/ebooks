...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body id="tab2">
    <div id="body-container">
      ...
      <div id="fm-container">
        <form name="productionEdit" action="" method="post">
          <fieldset>
            ...
            <input type="submit" name="editPickService"  class="fm-submit" value="Next"/>
          </fieldset>
        </form>
        <form name="testEdit" action="" method="post">
          <fieldset>
            ...
            <input type="submit" name="editPickTestService"  class="fm-submit" value="Next"/>
          </fieldset>
        </form>
      </div>
